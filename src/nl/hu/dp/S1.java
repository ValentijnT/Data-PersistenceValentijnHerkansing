...
//UPDATE medewerkers SET geslacht = 'V' WHERE mnr = 7788;
//
///*
//
//
...
//
//INSERT INTO medewerkers (mnr, naam, voorl, functie, gbdatum, maandsal, afd)
//VALUES (8000, 'DONK', 'A', 'DIRECTEUR', '1980-11-23', 5000, 50);
//
...
//
//*/
//Create sequence anr_seq START WITH 10 INCREMENT BY 10;
//ALTER TABLE afdelingen ALTER COLUMN anr SET DEFAULT nextval('anr_seq');
//ALTER TABLE afdelingen ALTER COLUMN anr SET DATA TYPE NUMERIC(5);
///*
//
//
//         S1.4. Adressen
...
//	CONSTRAINT chk_einddatum CHECK (einddatum > ingangsdatum),
...
//VALUES('3704AB', 8, '19-06-2024', '20-08-2024', 0612345678, 8000);
//
// /*
//
// S1.5. Commissie
